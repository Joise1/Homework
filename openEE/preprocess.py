...
def parse_file(input_file, corenlp_file):
    ...
    with open(corenlp_file, 'r', encoding='utf-8') as fin:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input', type=str, metavar='str', default='data/test',
                        help="input directory")
    parser.add_argument('--output', type=str, metavar='str', default='out/test.json.gz',
