...
# IMS (It Makes Sense)
wget http://www.comp.nus.edu.sg/~nlp/sw/IMS_v0.9.2.1.tar.gz --no-check-certificate
tar xvfz IMS_v0.9.2.1.tar.gz

wget http://www.comp.nus.edu.sg/~nlp/sw/lib.tar.gz --no-check-certificate
tar xvfz lib.tar.gz
mv lib ims_0.9.2.1

wget http://sterling8.d2.comp.nus.edu.sg/sw/models-MUN-SC-wn30.tar.gz --no-check-certificate
...
# WordNet (for IMS)
wget http://wordnetcode.princeton.edu/3.0/WordNet-3.0.tar.gz --no-check-certificate
