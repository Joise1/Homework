...
if __name__ == '__main__':
    ...
    parser.add_argument('--input', type=str, metavar='str', default='out/test_wsd.json.gz',
                        help="input file (gzipped JSON)")
    parser.add_argument('--output', type=str, metavar='str', default='out/test_wsd_phrase.json.gz',
