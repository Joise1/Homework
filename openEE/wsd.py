...
def run_ims(dataset, ims_dir):
    ...
    for sent in tqdm([sent for doc in dataset.docs for sent in doc.sents]):
        with open(IMS_IN, 'w', encoding='utf-8') as fout:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input', type=str, metavar='str', default='out/test.json.gz',
                        help="input file (gzipped JSON)")
    parser.add_argument('--output', type=str, metavar='str', default='out/test_wsd.json.gz',
